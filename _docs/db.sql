...
--
-- Tabellstruktur `calendar_categories`
--
...
--
-- Tabellstruktur `calendar_categories_rights`
--
...
--
-- Tabellstruktur `calendar_events`
--
...
--
-- Tabellstruktur `calendar_views_members`
--
...
--
-- Tabellstruktur `groups_default_members`
--
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `header` tinyint(2) unsigned NOT NULL DEFAULT '0' COMMENT '0:false (set static header image)',
...
--
-- Tabellstruktur `pages_calendars`
--
...
--
-- Tabellstruktur `pages_selections`
--
...
CREATE TABLE IF NOT EXISTS `site` (
  ...
  `site_template_content_padding` int(3) unsigned NOT NULL DEFAULT '0' COMMENT 'set content padding in px',
  ...
  `site_maintenance` int(1) DEFAULT NULL,
  ...
  `site_flash_version` varchar(100) COLLATE utf8_unicode_ci DEFAULT '11.0' COMMENT 'set required flash version',
