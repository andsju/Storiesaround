...
class Calendar extends Database
{
    ...
    public function getCalendarEventsList($calendar_categories_id, $date, $href = null, $period)
    {
        $acc_read = false;
     ...
     * @return string
     */
    public function getCalendarNav($date = null, $category_or_view, $id = null, $period = null)
    {
