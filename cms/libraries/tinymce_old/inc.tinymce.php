<?php
	...
	var url = "<?php echo $_SESSION['CMS_URL'];?>";
	var dir = "<?php echo $_SESSION['CMS_DIR'];?>";
?>
	tinymce.init({
		...
		plugins: [
			...
			"emoticons template paste textcolor moxiemanager youtube, textcolor"
		],
		toolbar1: "undo redo | bullist numlist | outdent indent | insertfile | image | forecolor backcolor",
		image_advtab: true,
		content_css : url+"/cms/css/layout_wysiwyg_editor.css?" + new Date().getTime(),
		style_formats: [
		...
		templates: [ 
			...
			{title: 'Lorem ipsum 5', description: 'Dummy text', url: url+'/cms/libraries/tinymce/template_lorem.html'} 
		],
		//image_list: url+"/cms/libraries/tinymce/image_list.php"
	 });
