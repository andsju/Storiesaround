...
function isValidString($string, $reg)
{
    if ((is_string(($string))) && is_string(($reg))) {
        ...
        // allowed string
        $allowed = array('username', 'strong_password', 'str', 'css', 'html', 'code', 'path', 'words', 'name', 'personnummer', 'personnummerPTF', 'milliseconds', 'alpha', 'numerical', 'alphanumerical', 'ratio', 'email', 'sevendigits', '0-9', '1-20', 'date', 'ip', 'url', 'url_query', 'hex', 'php', 'boolean', 'any-all', 'characters');
