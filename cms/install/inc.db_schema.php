...
CREATE TABLE `pages` (
  ...
  `story_event_date` datetime DEFAULT current_timestamp() COMMENT 'story event date',
  ...
  `utc_created` datetime DEFAULT current_timestamp() COMMENT 'created',
  `utc_modified` datetime DEFAULT current_timestamp() COMMENT 'modified',
