...
$limit = (isset($_GET['limit']) === true && intval($_GET['limit']) <= 30 && intval($_GET['limit']) > 0) ? intval($_GET['limit']) : 1;

// initiate class
//--------------------------------------------------
$cal = new Calendar();
$rows = $cal->getCalendarEventsRSS(1, $limit);
...
<html>
	...
	<body>
	<img src="img/calendar.jpg" style="float:right;width:400px;height:auto; margin:0 0 20px 20px;" />
	<?php 
	foreach($rows as $row) {
