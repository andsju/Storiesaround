...
foreach($rows as $row) {
	...
	if(strlen($row['questions']) > 0) {
		$section->writeText('Frågor', $font_heading_2, $paragraph_heading_2);
		$section->writeText($row['questions'], $font_body_text, $paragraph_body_text);
