...
if ($email_username = filter_input(INPUT_POST, 'email_username', FILTER_SANITIZE_FULL_SPECIAL_CHARS)) { 

	$trimmed = array_map('trim', $_POST);

	if ($action = filter_var($trimmed['action'], FILTER_SANITIZE_FULL_SPECIAL_CHARS)) {
...
if ($email1 = filter_input(INPUT_POST, 'email1', FILTER_SANITIZE_FULL_SPECIAL_CHARS)) { 
