...
CREATE TABLE `calendar_categories` (
  `calendar_categories_id` int(11) NOT NULL,
...
$sql_tables[] = 
"
CREATE TABLE `calendar_categories_rights` (
  `calendar_categories_rights_id` int(11) NOT NULL,
...
CREATE TABLE `calendar_views` (
  `calendar_views_id` int(11) NOT NULL,
...
$sql_tables[] = 
"
CREATE TABLE `calendar_views_members` (
  `calendar_views_members_id` int(11) NOT NULL,
...
$sql_tables[] = 
"
CREATE TABLE `groups_default` (
  `groups_default_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `description` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `active` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '0-false, 1-true',
  `utc_created` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
$sql_tables[] = 
"
CREATE TABLE `groups_default_members` (
  `groups_default_members_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `groups_members` (
  `groups_members_id` int(10) UNSIGNED NOT NULL,
  `groups_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0-false, 1-true',
...
CREATE TABLE `history` (
  ...
  `utc_datetime` datetime NOT NULL DEFAULT '1000-01-01 00:00:00'
) $charset_collate;
";
...
CREATE TABLE `history_email` (
  `history_email_id` int(11) NOT NULL,
...
CREATE TABLE `pages` (
  ...
  `grid_content` longtext COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'json format',
  ...
  `story_custom_title` tinyint(1) DEFAULT 0 COMMENT 'use custom title 0:false 1:true',
  ...
  `story_event_date` datetime NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'story event date',
  ...
  `rss_description` text COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'rss description',
  `utc_created` datetime NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'created',
  `utc_modified` datetime NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'modified',
...
$sql_tables[] = 
"
CREATE TABLE `pages_calendars` (
  `pages_calendars_id` int(11) NOT NULL,
...
CREATE TABLE `pages_images` (
  `pages_images_id` int(11) NOT NULL,
  `pages_id` int(11) NOT NULL DEFAULT 0,
  ...
  `sizes` varchar(50) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'comma separated width sizes in px',
...
$sql_tables[] = 
"
CREATE TABLE `pages_plugins` (
  `pages_plugins_id` int(11) NOT NULL,
...
$sql_tables[] = 
"
CREATE TABLE `pages_rights` (
  `pages_rights_id` int(11) NOT NULL,
  `pages_id` int(11) NOT NULL DEFAULT 0,
  `users_id` int(11) NOT NULL DEFAULT 0,
  `groups_id` int(11) NOT NULL DEFAULT 0,
  `rights_read` tinyint(1) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'read rights',
...
$sql_tables[] = 
"
CREATE TABLE `pages_selections` (
  `pages_selections_id` int(11) NOT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `content_html` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `content_code` text COLLATE utf8_unicode_ci DEFAULT NULL,
  `grid_content` longtext COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'json format',
  `grid_custom_classes` varchar(50) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'custom css',
  `grid_cell_template` tinyint(1) DEFAULT 0 COMMENT '0:image top 1:heading top',
  `grid_cell_image_height` int(3) DEFAULT 140 COMMENT 'height in px',
...
$sql_tables[] = 
"
CREATE TABLE `pages_stories` (
  `pages_stories_id` int(11) NOT NULL,
  `pages_id` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `pages_widgets` (
  `pages_widgets_id` int(11) NOT NULL,
...
CREATE TABLE `site` (
  ...
  `site_404` text COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '404 page not found',
  `site_about_cookies_url` varchar(255) COLLATE utf8_unicode_ci DEFAULT '' COMMENT 'read about cookies url',
...
CREATE TABLE `users` (
  ...
  `utc_created` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `utc_modified` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
  `utc_lastvisit` datetime NOT NULL DEFAULT '1000-01-01 00:00:00',
...
ALTER TABLE `calendar_categories`
  ADD PRIMARY KEY (`calendar_categories_id`);
";

$sql_tables[] = 
"
ALTER TABLE `calendar_categories_rights`
  ADD PRIMARY KEY (`calendar_categories_rights_id`);
";
...
ALTER TABLE `calendar_views`
  ADD PRIMARY KEY (`calendar_views_id`);
";

$sql_tables[] = 
"
ALTER TABLE `calendar_views_members`
  ADD PRIMARY KEY (`calendar_views_members_id`);
";
...
$sql_tables[] = 
"
ALTER TABLE `groups_default`
  ADD PRIMARY KEY (`groups_default_id`);
";

$sql_tables[] = 
"
ALTER TABLE `groups_default_members`
  ADD PRIMARY KEY (`groups_default_members_id`);
";

$sql_tables[] = 
"
ALTER TABLE `groups_members`
  ADD PRIMARY KEY (`groups_members_id`);
";
...
ALTER TABLE `history_email`
  ADD PRIMARY KEY (`history_email_id`);
";
...
$sql_tables[] = 
"
ALTER TABLE `pages_calendars`
  ADD PRIMARY KEY (`pages_calendars_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_categories`
  ADD PRIMARY KEY (`pages_categories_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_images`
  ADD PRIMARY KEY (`pages_images_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_plugins`
  ADD PRIMARY KEY (`pages_plugins_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_rights`
  ADD PRIMARY KEY (`pages_rights_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_selections`
  ADD PRIMARY KEY (`pages_selections_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_stories`
  ADD PRIMARY KEY (`pages_stories_id`);
";

$sql_tables[] = 
"
ALTER TABLE `pages_widgets`
  ADD PRIMARY KEY (`pages_widgets_id`);
";
...
"
ALTER TABLE `calendar_categories`
  MODIFY `calendar_categories_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `calendar_categories_rights`
  MODIFY `calendar_categories_rights_id` int(11) NOT NULL AUTO_INCREMENT;
";
...
"
ALTER TABLE `calendar_views`
  MODIFY `calendar_views_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `calendar_views_members`
  MODIFY `calendar_views_members_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `groups`
  MODIFY `groups_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `groups_default`
  MODIFY `groups_default_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `groups_default_members`
  MODIFY `groups_default_members_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `groups_members`
  MODIFY `groups_members_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
";
...
"
ALTER TABLE `history_email`
  MODIFY `history_email_id` int(11) NOT NULL AUTO_INCREMENT;
";
...
"
ALTER TABLE `pages_calendars`
  MODIFY `pages_calendars_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_categories`
  MODIFY `pages_categories_id` int(3) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_images`
  MODIFY `pages_images_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_plugins`
  MODIFY `pages_plugins_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_rights`
  MODIFY `pages_rights_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_selections`
  MODIFY `pages_selections_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_stories`
  MODIFY `pages_stories_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `pages_widgets`
  MODIFY `pages_widgets_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `plugins`
  MODIFY `plugins_id` int(11) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `site`
  MODIFY `site_id` int(1) NOT NULL AUTO_INCREMENT;
";

$sql_tables[] = 
"
ALTER TABLE `tags`
  MODIFY `tags_id` int(1) NOT NULL AUTO_INCREMENT;
";
...
"
ALTER TABLE `widgets`
  MODIFY `widgets_id` int(11) NOT NULL AUTO_INCREMENT;
";
