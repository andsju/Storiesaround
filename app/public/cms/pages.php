...
// page title
$page_title_head = !is_null($arr['title_tag']) && strlen($arr['title_tag']) > 0 ? $arr['title_tag'] : $arr['title'];
$page_title_body = $arr['title_hide'] == 1 ? $arr['title_alternative'] : $arr['title'];

// meta tags
$meta_keywords = (is_string($arr['meta_keywords']) && strlen($arr['meta_keywords'])>0) ? $arr['meta_keywords'] : null;
$meta_description = (is_string($arr['meta_description']) && strlen($arr['meta_description'])>0) ? $arr['meta_description'] : null;
$meta_robots = (is_string($arr['meta_robots']) && strlen($arr['meta_robots'])>0) ? $arr['meta_robots'] : null;
$meta_additional = (is_string($arr['meta_additional']) && strlen($arr['meta_additional'])>0) ? $arr['meta_additional'] : null;
...
// selections
$pages_selections = is_null($arr['selections']) ? null : explode(",",$arr['selections']);
...
$language =  !is_null($arr['lang']) && strlen($arr['lang']) > 0 ? $arr['lang'] : $_SESSION['site_lang'];
...
<body id="<?php echo $add_id_landing_page;?>">
    ...
    <div id="wrapper-site-header"> 
        <header id="site-header">
            ...
            <?php
            if ( !is_null($selection_area['header']) && strlen($selection_area['header'])) {
