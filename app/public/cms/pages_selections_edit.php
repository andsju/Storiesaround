					...
					echo '<table style="width:100%;">';
						...
						echo '<tr>';
							echo '<td style="padding-top:10px;" colspan="4">';
								...
								<textarea name="content_code" id="content_code" style="width:100%;height:100px;" class="code"><?php echo is_null($row[0]['content_code']) ? "" : htmlspecialchars($row[0]['content_code']); ?></textarea>
								</div>
								<?php
							echo '</td>';
						echo '</tr>';
