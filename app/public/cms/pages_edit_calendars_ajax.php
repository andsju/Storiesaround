		...
		if ($pages_id = filter_input(INPUT_POST, 'pages_id', FILTER_VALIDATE_INT)) { 
			...
			switch ($action) {
				...
				case 'calendar_events_set':
					...
					$period_initiate = filter_var(trim($_POST['period_initiate']), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
					$calendar_area = filter_var(trim($_POST['calendar_area']), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
