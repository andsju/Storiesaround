	...
	if ($_POST['token'] == $_SESSION['token']) {
		...
		if ($pages_id = filter_input(INPUT_POST, 'pages_id', FILTER_VALIDATE_INT)) { 
			...
			switch ($action) {
				...
				case 'calendar_rights_add_users':
				...
				case 'calendar_rights_add_groups':
				...
				case 'calendar_rights_delete':
					$calendar_rights_id = $_POST['calendar_rights_id'];
					$rights = new CalendarRights();
					$row = $rights->setCalendarUsersRightsDelete($calendar_categories_rights_id);
					break;


				case 'calendar_rights_save':
