...
<div style="padding:20px;" class="ui-black-white">
	...
	<div style="float:left;width:34%;">
		<b>All</b>
		<?php get_pages_tree_sitemap_all($id, $path=get_breadcrumb_path_array($id), $seo=false, $href, $depth=1, $show_pages_id = true, $parent_id=0, $a=true, $a_add_class='colorbox_edit', $open=true); ?>
	</div>
	<div style="float:left;width:33%;">
		<b>Published</b>
		<?php get_pages_tree_sitemap($id, $path=get_breadcrumb_path_array($id), $seo=false, $href, $depth=1, $show_pages_id = true, $parent_id=0, $a=true, $a_add_class='colorbox_edit', $open=true); ?>
	</div>
	<div style="float:left;width:33%;">
